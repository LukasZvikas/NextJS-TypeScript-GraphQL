...
var REGISTER_MUTATION = graphql_tag__WEBPACK_IMPORTED_MODULE_1___default()(_templateObject());
...
/***/ "./utilities/authValidation.ts":
/*!*************************************!*\
  !*** ./utilities/authValidation.ts ***!
  \*************************************/
/*! exports provided: validateEmail, validatePasswordMatch, validatePasswordLength */
/***/ (function(module, __webpack_exports__, __webpack_require__) {
...
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "validatePasswordLength", function() { return validatePasswordLength; });
var regex = /^(([^<>()\[\]\\.,;:\s@"]+(\.[^<>()\[\]\\.,;:\s@"]+)*)|(".+"))@((\[[0-9]{1,3}\.[0-9]{1,3}\.[0-9]{1,3}\.[0-9]{1,3}])|(([a-zA-Z\-0-9]+\.)+[a-zA-Z]{2,}))$/;
var validateEmail = function validateEmail(email) {
  var invalidEmail = regex.test(email);
  return invalidEmail;
};
var validatePasswordMatch = function validatePasswordMatch(passwordOne, passwordTwo) {
...
var validatePasswordLength = function validatePasswordLength(password) {
