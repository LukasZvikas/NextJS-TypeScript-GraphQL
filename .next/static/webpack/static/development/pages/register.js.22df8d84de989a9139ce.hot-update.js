          ...
          while (1) {
            switch (_context.prev = _context.next) {
              case 0:
                console.log("eee", e);
                e.preventDefault();
                console.log("state", _this.state); //const { email, password } = this.state;
                //const response = await registerMutation({ variables: { email, password } });
...
//# sourceMappingURL=register.js.22df8d84de989a9139ce.hot-update.js.map